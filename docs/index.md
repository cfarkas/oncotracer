...
The first run takes longer because it prepares the human reference genome and analysis tools. The [installation page](installation.md) lists memory and storage requirements. Your input files stay in their original folders; results go to the `outdir` saved in your configuration.
